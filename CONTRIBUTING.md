# Contributing to DAWO NixOS

Thank you for your interest in contributing! To maintain a high standard of quality and clarity, please follow our contribution guidelines.
...
*Example:* `feat(networking): add BGP support with community tags`
*Common types:* 
- `feat`: A new feature.
- `fix`: A bug fix.
...
## Let's Build!
Better yet, let's make this the coolest NixOS setup in the neighborhood. Feel free to reach out if you have any questions before starting your first PR!
